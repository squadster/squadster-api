defmodule Squadster.Domain.Accounts.UsersSpec do
  ...
  describe "changeset functions" do
    defmodule ItSetsHashId do
      use ESpec, shared: true

      let_overridable :changeset_function

      context "when user does not have hash_id yet" do
      ...
      context "when user has hash_id" do
    ...
    describe "changeset" do
      context "when params are valid" do
        ...
        it_behaves_like ItSetsHashId, changeset_function: :changeset
      end
    ...
    describe "auth_changeset" do
      context "when params are valid" do
        ...
        it_behaves_like ItSetsHashId, changeset_function: :auth_changeset
